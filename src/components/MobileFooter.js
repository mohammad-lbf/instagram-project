...
const MobileFooter = ({path}) => {
    return (
        <div className="d-flex justify-content-between px-3 px-sm-5 mobile-footer py-2 align-items-center d-lg-none">
            ...
            <Link to="/profile"><img className={`icon ${path == "/profile" ? "border border-dark" : "border-0"} rounded-circle`} src={profileImage} alt="profile-image" /></Link>
        </div>
    );
};
