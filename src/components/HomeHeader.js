...
const HomeHeader = ({path}) => {
    return (
        ...
        <div className={`${path == "/home" ? "d-flex" : "d-none"} flex-row-reverse justify-content-between d-lg-none px-3 px-sm-5 py-2 align-items-center`}>
            <Link to="/direct"><i className="bi bi-send icon text-dark"></i></Link>
            <img className="logo" alt="logo" src={instagramLogo} />
        </div>
        {/* desktop home  header */}
